...
#%% tansfer the weight of badModel to epModel
trans_weights = bad_ANN.layers[3].get_weights()
# origin = ep_ANN.layers[3].get_weights()
...
fig.savefig('./Figure/case1Model_test.png', dpi = 350, bbox_inches = 'tight')
...
fig.savefig('./Figure/case1Model_input_operation.png', dpi = 350, bbox_inches = 'tight')
