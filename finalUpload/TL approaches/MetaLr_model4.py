...
#%% tansfer the weight of epModel to badModel
...
fig.savefig('./Figure/case2Model_test.png', dpi = 350, bbox_inches = 'tight')
...
fig.savefig('./Figure/case2Model_input_operation.png', dpi = 350, bbox_inches = 'tight')