...
#%%
os.chdir(r'C:\Users\YourPCPC\Desktop\DS_MetaLr')
meta_ANN = build_ANN(out01_sa_scaled_vs2.shape[1], (in01_sa_scaled_vs2.shape[1],), (30, 30, 30))
checkpoint = ModelCheckpoint('./Model/saPred_target_weight.h5', monitor = 'loss', verbose = 1, save_best_only = True)
#es = EarlyStopping(monitor='loss', mode='min', patience = 30)
meta_ANN.fit(x01tr_sa, y01tr_sa, epochs = 200, callbacks = [checkpoint])
meta_ANN.load_weights('./Model/saPred_target_weight.h5')
meta_ANN.save('./Model/saPred_Target.h5')
#%%
...
fig.savefig('./Figure/targetModel_test.png', dpi = 350, bbox_inches = 'tight')
...
fig.savefig('./Figure/targetModel_input_operation.png', dpi = 350, bbox_inches = 'tight')